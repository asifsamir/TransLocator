...
class TextPreprocessor:
    def __init__(self, use_stemmer=False, use_lemmatizer=False, remove_stopwords=True, return_tokens=True, remove_only_digits=True, remove_single_char=True, remove_SE_stop_words=False):
